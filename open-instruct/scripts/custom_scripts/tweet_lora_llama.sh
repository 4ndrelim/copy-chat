...
TRAIN_FILE=$HOME/copy-chat/open-instruct/datasets/formatted_datasets/prepared_sentiment_generation.jsonl
OUTPUT_PATH=$HOME/copy-chat/models/adaptors/sentiment_generation_$MODEL_NAME
