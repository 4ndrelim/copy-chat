...
# TRAIN_FILE=/home/andre/andre/ml-frameworks/open-instruct/datasets/formatted_datasets/prepared_sentiment_generation.jsonl
# OUTPUT_PATH=/home/andre/andre/models/adaptors/sentiment_generation_$MODEL_NAME/
