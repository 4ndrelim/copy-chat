...
python dataset_preparation/tsad_sentiment_generation_preparer.py --dataset_name $1 --input_path ../dataset/tweet_sentiment/train/zixuan_andre/train_vanilla_augment.jsonl --template_path dataset_preparation/prompt_templates/tweet_sentiment_generation.json --output_path datasets/formatted_datasets/$1_train_vanilla_augment.jsonl
echo "Wrote train_vanilla_augment dataset to datasets/formatted_datasets/$1_train_vanilla_augment.jsonl"
