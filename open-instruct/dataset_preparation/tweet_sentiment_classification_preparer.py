...
# python -m dataset_preparation.tweet_sentiment_classification_preparer --dataset_name tweets_sentiment --input_path datasets/raw_datasets/tweets/train.csv --template_path dataset_preparation/prompt_templates/improved_tweet.json --output_path datasets/formatted_datasets/prepared_improved_tweet.jsonl